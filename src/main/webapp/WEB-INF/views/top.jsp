...
<link rel="stylesheet" type="text/css" href="resources/css/listtt.css">
 <title>F4</title>
    <link rel="icon" href="https://i.ibb.co/Wxv3M0D/son01.jpg" type="image/jpeg">
</head>
<style>
#hd .gnb li:last-child {
   margin-left: 0 !important;
...
<aside id="quick" float="left">
   <ul>
     <%--  <li><a href=""><c:out value="${dto[0].storeName}" /></a></li>
      ...
      <li><a href="blog.do" target="_blank"><img
         ...
         <div class="area">
            ...
            <div class="gnb">
               <ul>
                  ...
                  <li><a href="blogtop.do">블로그 탑</a></li>
                  <li><a href="test01.do">블로그222 탑</a></li>
                  <li><a href="test0101.do">자동완성 </a></li>
                  <li><a href="testbox.do">박스 테스트</a></li>
                  <li><a href="dong2.do">회원가입 동의 후</a></li>
                  <li><p>/</p>
                  <li><p>/</p>  
                  <div class="logo">
                        <c:if test="${isLogin}">
